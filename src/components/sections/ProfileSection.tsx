...
const ProfileSection = () => {
	return (
		<div className="raleway flex justify-start md:justify-center lg:justify-center items-center h-screen w-full lg:flex-row flex-col mt-15 md:mt-0 lg:mt-0 xl:mt-0">
			...
			<div className="relative isolate hidden xl:block">
				<div className="absolute top-30 left-30 w-120 h-120 bg-[#E8E6E6] "></div>
